  ...
  const listImgAff = [
    ...
    },
    {
      ...
      listLinkAff: [
        ...
        {
          title: "Orbitkey Desk Mat Medium - Mouse Pad and Desk Organizer Black",
    ...
    },
    {
      ...
      imgCoverLink: "/7.png",
      listLinkAff: [
        { title: "Logitech G Pro X Superlight 2 Lightspeed Wireless Gaming", linkAff: "https://amzn.to/47Aw2Kk" },
        {
          title: "Apple Magic Keyboard with Touch ID and Numeric Keypad: Wireless, Bluetooth",
          linkAff: "https://amzn.to/4devs6f",
        },
        {
          title: "LG 28MQ780-B 28 Inch SDQHD (2560 x 2880) Nano IPS DualUp Monitor with ",
          linkAff: "https://amzn.to/3MSwaLI",
        },
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/3TGR2tk" },
        {
          title:
    ...
    },
    {
      ...
      listLinkAff: [
        ...
        { title: "Apple Magic Mouse: Wireless, Bluetooth", linkAff: "https://amzn.to/3TCnkp8" },
        {
          title: "Apple Studio Display - Nano-Texture Glass - Tilt- and Height-Adjustable Stand ​​​​​​​",
          linkAff: "https://amzn.to/4ecUXWW",
        },
        {
          title: "PyleUsa HiFi Active Bookshelf Speaker with Bluetooth - Audio Stereo Monitor Speaker System",
    ...
    },
    {
      ...
      listLinkAff: [
        {
          title: "SAMSUNG 27-Inch S39C Series FHD Curved Gaming Monitor, 75Hz, AMD FreeSync, ",
          linkAff: "https://amzn.to/3XQ8P3F",
        },
        {
          title: "Logitech MX Master 3S for Mac Wireless Bluetooth Mouse, Ultra-Fast Scrolling",
          linkAff: "https://amzn.to/4e9Jpnt",
        },
        {
          title: "Keychron K4 Hot swappable Wireless Bluetooth/USB Wired Mechanical Gaming Keyboard",
          linkAff: "https://amzn.to/3TFgIGJ",
        },
        { title: "Marshall Emberton II Portable Bluetooth Speaker, Cream", linkAff: "https://amzn.to/4e7mQzA" },
      ],
    },
    {
      ...
      listLinkAff: [
        {
          title: "SAMSUNG 49-Inch Odyssey G9 Series DQHD 1000R Curved Gaming Monitor, 1ms(GtG)",
    ...
    },
    {
      ...
      imgCoverLink: "/11.png",
      listLinkAff: [
        { title: "MSI G274, 27 Gaming Monitor, 1920 x 1080 (FHD)", linkAff: "https://amzn.to/3MTxNsv" },
        { title: "Logitech G Wireless Gaming Combo", linkAff: "https://amzn.to/3MTxYUH" },
        { title: "FIFINE XLR/USB Microphone with 3.5mm/6.35mm Headphones,", linkAff: "https://amzn.to/3ZvvF1P" },
        {
          title: "Logitech G PRO X Gaming Headset (2nd Generation) with Blue Yeti",
          linkAff: "https://amzn.to/3ZvvQKx",
        },
        {
          title: "8Bitdo Ultimate 2.4G Wireless Controller, Hall Effect Joystick Update",
    ...
    },
    {
      ...
      imgCoverLink: "/12.png",
      listLinkAff: [
        { title: "Yamaha HS3 Powered Studio Monitor in White, Pair (HS3 W)", linkAff: "https://amzn.to/3ZFYhVU" },
        {
          title: "Logitech MX Master 3S for Mac Wireless Bluetooth Mouse, Ultra-Fast Scrolling, Ergo",
          linkAff: "https://amzn.to/4eprSra",
        },
        { title: "Keychron K8 Tenkeyless Wireless Mechanical Keyboard for Mac", linkAff: "https://amzn.to/3XQ9mTd" },
        { title: "Apple Studio Display - Standard Glass", linkAff: "https://amzn.to/4gyRPpM" },
        {
    ...
    },
    {
      ...
      imgCoverLink: "/13.png",
      listLinkAff: [
        { title: "Kensington iPad Docking Station", linkAff: "https://amzn.to/3XCz8sz" },
        {
          title: "Edifier MR4 Powered Studio Monitor Speakers with 7 Desktop Speaker Stands 1 Pair",
          linkAff: "https://amzn.to/4dfg3To",
        },
        {
          title: "HP E24 G5 23.8 Full HD LCD Monitor - 16:9-24 Class - in-Plane Switching (IPS) Technology",
    ...
    },
    {
      ...
      listLinkAff: [
        ...
        { title: "Logitech MX Master 3S, Black", linkAff: "https://amzn.to/3Bqk3CY" },
        {
        ...
        { title: "Beats Solo 4 Wireless Headphones - Matte Black", linkAff: "https://amzn.to/3BaONIm" },
      ],
    },
    {
      ...
      imgCoverLink: "/15.png",
      listLinkAff: [
        { title: "LG C3 Series 42-Inch Class OLED evo 4K Processor Smart TV", linkAff: "https://amzn.to/47yYMmT" },
        { title: "Logitech MX Master 3S, Black", linkAff: "https://amzn.to/3XTMBhh" },
        { title: "Audioengine A2 White Bluetooth Speakers and DS1M Metal Stands", linkAff: "https://amzn.to/47AdslA" },
        { title: "Apple Mac Mini Desktop Computer", linkAff: "https://amzn.to/4eaR18Z" },
        { title: "Londo Top Grain Leather Extended Mouse Pad - Desk Mat (Black)", linkAff: "https://amzn.to/3XV3BUp" },
      ],
    },
    {
      ...
      imgCoverLink: "/16.png",
      listLinkAff: [
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/3zw3MMq" },
        { title: "Apple Magic Keyboard with Touch ID: Wireless", linkAff: "https://amzn.to/3zu42LM" },
        {
          title: "Logitech MX Master 3S - Wireless Performance Mouse with Ultra-fast Scrolling",
          linkAff: "https://amzn.to/3XE9bZM",
        },
        {
          title: "BenQ ScreenBar Monitor Light, LED Computer Monitor Lamp, Auto-Dimming, Hue Adjustment Features",
    ...
    },
    {
      ...
      listLinkAff: [
        {
          title: "LG 38WN95C-W Monitor 38 21:9 Curved UltraWide QHD+ (3840 x 1600) Nanio IPS Display",
          linkAff: "https://amzn.to/47BLztk",
        },
        { title: "BenQ ScreenBar Monitor Light, LED Computer Monitor Lamp", linkAff: "https://amzn.to/3TCSJrA" },
        {
          title: "Logitech for Creators Blue Sona Active Dynamic XLR Broadcast Microphone for Streaming",
          linkAff: "https://amzn.to/3ZB6H16",
        },
        { title: "Apple Magic Trackpad", linkAff: "https://amzn.to/3TzHfFl" },
        { title: "Elgato Stream Deck MK.2 – Studio Controller", linkAff: "https://amzn.to/3zr0JoM" },
      ],
    },
    {
      ...
      imgCoverLink: "/18.png",
      listLinkAff: [
        { title: "LG Ultragear 4K UHD 32-Inch Gaming Monitor 32GQ750-B", linkAff: "https://amzn.to/3XDuz1v" },
        {
          title: "Razer Cobra Pro Wireless Gaming Mouse: 10 Customizable Controls",
          linkAff: "https://amzn.to/3XSDfCf",
        },
        { title: "Audioengine A2 White Bluetooth Speakers and DS1M Metal Stands", linkAff: "https://amzn.to/3TEErXD" },
        { title: "Azar Displays, 900945-WHT, 70 Piece Pegboard Organizer,", linkAff: "https://amzn.to/3XDvVce" },
        {
          title:
    ...
    },
    {
      ...
      imgCoverLink: "/19.png",
      listLinkAff: [
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/4eckejV" },
        { title: "Apple 2021 MacBook Pro", linkAff: "https://amzn.to/4dfgRaS" },
        { title: "Logitech MX Master 3S, Black", linkAff: "https://amzn.to/4gzVYd1" },
        { title: "Edifier MR4 Powered Studio Monitor Speakers with SS5", linkAff: "https://amzn.to/3BhEHFx" },
        {
          title: "Logitech MX Mechanical Wireless Illuminated Performance Keyboard,",
    ...
    },
    {
      ...
      imgCoverLink: "/20.png",
      listLinkAff: [
        { title: "VILVA Portable-Monitor-for-Laptop - 15.6", linkAff: "https://amzn.to/3ZAwuGK" },
        {
          title: "SAMSUNG 32-Inch Odyssey G55C Series QHD 1000R Curved Gaming Monitor, 1ms(MPRT), H",
    ...
    },
    {
      ...
      imgCoverLink: "/21.png",
      listLinkAff: [
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/47yInPj" },
        {
          title: "Apple Mac Mini Desktop Computer, M2 Chip with 8-Core CPU and 10-",
          linkAff: "https://amzn.to/3ZuKHVx",
        },
        {
          title: "Apple Magic Keyboard with Touch ID and Numeric Keypad: Wireless",
          linkAff: "https://amzn.to/4dezBaj",
        },
        { title: "Logitech MX Master 3S, Black", linkAff: "https://amzn.to/4diJC6u" },
        {
          title: "Aothia Large Dual Monitor Stand Riser, Solid Wood Desk Shelf with Eco Cork Legs for",
    ...
    },
    {
      ...
      imgCoverLink: "/22.png",
      listLinkAff: [
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/4eaTbW9" },
        { title: "Apple Mac Mini Desktop Co", linkAff: "https://amzn.to/3BnvJXa" },
        {
          title: "Apple Magic Keyboard with Touch ID and Numeric Keypad: Wireless, Bluetooth",
          linkAff: "https://amzn.to/3ZAxZVo",
        },
        {
          title: "Aothia Large Dual Monitor Stand Riser, Solid Wood Desk Shelf with Eco Cork Legs for Laptop C",
    ...
    },
    {
      ...
      imgCoverLink: "/23.png",
      listLinkAff: [
        { title: "Apple Studio Display - Standard Glass - Tilt-Adjustable Stand", linkAff: "https://amzn.to/3zu5JZE" },
        {
          title: "Apple 2023 Mac Mini Desktop Computer M2 chip with 8 core CPU and ",
        ...
        { title: "Logitech MX Master 3S, Black", linkAff: "https://amzn.to/3XDvMWB" },
        {
          title: "Aothia Large Dual Monitor Stand Riser, Solid Wood Desk Shelf with Eco Cork Legs for Laptop Computer/",
